import type { IAuthResponse, ISignUpData } from '@the5ers-stocks-app/shared-types';
...
export class UserService {
  ...
  async signIn(dto: SignInDto) {
    ...
    if (!user) {
      throw new HttpException('Login error, please check your credentials', HttpStatus.BAD_REQUEST);
    }
